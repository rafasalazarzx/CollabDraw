...
- (IBAction)clearCanvas:(id)sender
{
	...
	[alert setMessage:@"¿Está seguro de querer limpiar el lienzo?" ];
...
- (IBAction)tweetCanvas:(id)sender
{
    ...
    [twitter setInitialText:@"Mi dibujo #CollabDraw" ];
    ...
    twitter.completionHandler = ^(TWTweetComposeViewControllerResult res) {
        ...
        if(res == TWTweetComposeViewControllerResultDone)
        {
            ...
            UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"CollabDraw" message:@"Su dibujo fue twitteado con éxito." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
        ...
        }else if(res == TWTweetComposeViewControllerResultCancelled)
        {
            ...
            UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"CollabDraw" message:@"Error al enviar tweet." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
