...
- (IBAction)toolChange:(id)sender
{
    ...
    {
        excentricidadTextoLabel.text = @"Text:";
        texto.hidden = NO;
    ...
    {
        excentricidadTextoLabel.text = @"Excentricity:";
        texto.hidden = YES;
...
- (IBAction)clearCanvas:(id)sender
{
	...
	[alert setMessage: @"Are you sure you want to clear the canvas?"];
...
- (IBAction)tweetCanvas:(id)sender
{
    ...
    [twitter setInitialText: @"My drawing #CollabDraw" ];
    ...
    twitter.completionHandler = ^(TWTweetComposeViewControllerResult res) {
        ...
        if(res == TWTweetComposeViewControllerResultDone)
        {
            ...
            UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"CollabDraw" message:@"Your drawing was tweeted successfully." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
        ...
        }else if(res == TWTweetComposeViewControllerResultCancelled)
        {
            ...
            UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"CollabDraw" message:@"There was an error while sending your tweet." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
